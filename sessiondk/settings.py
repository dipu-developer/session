"""
Django settings for sessiondk project.
...
SECRET_KEY = 'django-insecure-^$h2hyrn!)(-_u_vw!#idn*sgq$z)yybjep8^(gt@1y9ii30c!'
...
WSGI_APPLICATION = 'sessiondk.wsgi.application'
